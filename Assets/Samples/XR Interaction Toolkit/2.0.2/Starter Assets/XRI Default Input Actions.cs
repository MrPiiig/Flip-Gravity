...
public partial class @XRIDefaultInputActions : IInputActionCollection2, IDisposable
{
        ...
        },
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""Change Gravity"",
                    ""type"": ""Button"",
                    ""id"": ""636a9053-72b5-4fd9-8f20-48c15b3139a9"",
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""ba3d2ac1-a3eb-403c-955e-a4ef9670e66f"",
    ...
    ""controlSchemes"": [
        ...
        m_XRILeftHand_ChangeGravity = m_XRILeftHand.FindAction("Change Gravity", throwIfNotFound: true);
    ...
    private readonly InputAction m_XRILeftHand_ChangeGravity;
    public struct XRILeftHandActions
    {
        ...
        public InputAction @ChangeGravity => m_Wrapper.m_XRILeftHand_ChangeGravity;
        ...
        public void SetCallbacks(IXRILeftHandActions instance)
        {
            if (m_Wrapper.m_XRILeftHandActionsCallbackInterface != null)
            {
                ...
                @ChangeGravity.started -= m_Wrapper.m_XRILeftHandActionsCallbackInterface.OnChangeGravity;
                @ChangeGravity.performed -= m_Wrapper.m_XRILeftHandActionsCallbackInterface.OnChangeGravity;
                @ChangeGravity.canceled -= m_Wrapper.m_XRILeftHandActionsCallbackInterface.OnChangeGravity;
            }
